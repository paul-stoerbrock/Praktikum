...
\subsection{a)}
    ...
    \flushleft{Als\;}\justifying geeignete Basis werden die Energieeigenzustände verwendet:
    \begin{align*}
        \ket{\Psi} &= \Psi_n \ket{n}\\
        \\
        ...
        &\leq \sum_{n,m} \Psi_n^* \bra{n} E_0 \ket{m} \Psi_m \qquad \text{mit}\; \braket{n}{m} = \delta_{nm}\\
