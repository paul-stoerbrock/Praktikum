...
Viele modernen Technologien benötigen Kenntnisse über die Leitfähigkeit von verschiedenen
...
mit dem Python Befehl np.polyfit \cite{numpy} und der Formel $y = mx + b$ erstellt. Die Parameter $m$ und $b$ werden mit 
den Formeln 
\begin{subequations}
\begin{align}
...
$I_B$ für Kupfer wieder. Das Magnetfeld $B$ wird aus der Geradengleichung $B = m_{auf} \cdot I_B + b_{auf}$ gewonnen. 
...
\begin{align}
    m_{a)} &= \text{\input{m_Cu_IB.tex}} \label{eq:17a}\\
    b_{a)} &= \text{\input{b_Cu_IB.tex}} \label{eq:17b}\\
    m_{b)} &= \text{\input{m_Cu_IQ.tex}} \label{eq:17c}\\
    b_{b)} &= \text{\input{b_Cu_IQ.tex}} \label{eq:17d}
\end{align}
\end{subequations}
...
Das B-Feld aus der Geradengleichung $B = m_{auf} \cdot I + b_{auf}$ folgt. Wird der Wert mit dem dazugehörigen Werten aus
...
\begin{align}
    m_{a)} &= \text{\input{m_Ag_IB.tex}} \label{eq:28a}\\
    b_{a)} &= \text{\input{b_Ag_IB.tex}} \label{eq:28b}\\
    m_{b)} &= \text{\input{m_Ag_IQ.tex}} \label{eq:28c}\\
    b_{b)} &= \text{\input{b_Ag_IQ.tex}} \label{eq:28d}
\end{align}
\end{subequations}
...
\begin{align}
    m_{a)} &= \text{\input{m_Zn_IB.tex}} \label{eq:29a}\\
    b_{a)} &= \text{\input{b_Zn_IB.tex}} \label{eq:29b}\\
    m_{b)} &= \text{\input{m_Zn_IQ.tex}} \label{eq:29c}\\
    b_{b)} &= \text{\input{b_Zn_IQ.tex}} \label{eq:29d}
\end{align}
\end{subequations}
...
% Kupfer ===============================================================================================================================================================================================================
\flushleft{Die\;}\justifying Graphen \ref{fig:3a} und \ref{fig:3b} geben den linearen Verlauf der Gleichung \eqref{eq:1}
wieder. Zudem entspricht die positive Hallspannung dem, was bei Kupfer zu erwarten ist.

\flushleft{Für\;}\justifying den relativen Fehler des spezifischen Widerstands von Kupfer ergibt sich:
\begin{align}
    \frac{\varrho - \varrho_{Lit.}}{\varrho_{Lit.}} = \text{\input{rho_Cu_err.tex}}
\end{align}

\flushleft{Der\;}\justifying relative Fehler ist dabei sehr gering, was für einen guten Messwert spricht.
...
% Silber ===============================================================================================================================================================================================================
Für Silber weicht der bestimmte spezifische Widerstand auch nicht weit vom Literaturwert ab und zeigt eine relativ fehlerfreie Messung an:
\begin{align}
...
% Zink ===============================================================================================================================================================================================================
Für Zink wurde als spezifischer Widerstand ein Literaturwert verwendet, da zu dieser
