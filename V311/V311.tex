...
\begin{align}
    ...
    \intertext{
        ...
        \abs{v_{Cu}} &\approx \sqrt{\frac{2 E_F}{m_0}} = \text{\input{v_Cu_IB.tex}} \label{eq:25}
    \intertext{
...
\subsubsection{Konstantes B-Feld} \label{sec:5.3.1}
...
\centering
    ...
    \toprule
        ...
        Totalgeschwindigkeit                    &$\abs{v_{Cu}}$         = & \text{\input{v_Cu_IQ.tex}}  \\
