...
\section{Auswertung}
    ...
    Der folgende Graph stellt das Verhältnis zwischen Photostrom $I_{\text{Photo}}$ und der dazugehörigen Spannung $U$ dar. Die dazu verwendeten Messwerte sind in Tabelle \ref{tab:1}
    zu finden und die 
