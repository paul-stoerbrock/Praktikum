...
\subsection{Gelbe Spektrallinie}
    ...
    \begin{align}
    0 &= m U_g+b \Leftrightarrow -\frac{b}{m} = U_g \label{eq:7}
    \intertext{
        \flushleft{Fehlerfortpflanzung\;}\justifying
    }
    \frac{b}{2m^2} &= U_g
    U_g &= \text{\input{U_g_gelb_err.tex}} \label{eq:8}
    \end{align}
...
\subsection{Verhältnis und Austrittsarbeit}
    ...
    \begin{align}
    \nu_{\text{Gelb}} &= \text{\input{f_gelb.tex}}\\
    \nu_{\text{Grün}} &= \text{\input{f_gruen.tex}}\\
    \nu_{\text{Rot}} &= \text{\input{f_rot.tex}}
    \end{align}
    ...
    \begin{align}
    m &= \text{\input{m_f.tex}}\;\text{und}\\
    b &= \text{\input{b_f.tex}},\\
    Fehler &= \text{\input{fehler.tex}}   
    \end{align}
