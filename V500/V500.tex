...
\section{Theorie}
    ...
    \end{align}
    \flushleft{Durch\;}\justifying die Einführung eines Gegenfeldes wird erwartet, dass nur die Elektronen mit der größten Geschwindigkeit, also der größten kinetischen Energie, den Anodendraht erreichen. 
...
\section{Versuchsaufbau und Durchführung}
    ...
    \begin{figure}[H]
        ...
        \label{fig:6}
    \end{figure}
    \flushleft{Die\;}\justifying Spektrallinien werden einzeln mithilfe des Schwenkarms auf die Photozelle gerichtet.
...
\subsection{Grüne Spektrallinie}
    ...
    \begin{align}
    U_g &=\text{\input{U_g_gruen_err.tex}} \label{eq:13}
    \end{align}
...
\subsection{Rote Spektrallinie}
    ...
    \begin{align}
    U_g &=\text{\input{U_g_rot_err.tex}} \label{eq:16}
    \end{align}
