...
\section{Aufgabe 4}
    ...
    Die Formel des Strahlungsflusses lautet:
    }
        f = \frac{L_{Stern}}{A} \label{eq:2}
    \end{align}
...
\flushleft{Der\;}\justifying Unterschied liegt in der kreisförmigen Struktur des CNO-Zykluses, da die pp-Kette ihr Endstadium mit $^4He$ erreicht hat. Der CNO-Zyklus knüpft jedoch an dem letzen Schritt wieder
