...
\end{figure}
    ...
    \end{align*}
    \flushleft{Hierbei\;}\justifying zerfällt ^{56}Nickel zu ^{56}Cobalt, einem Proton und einem Elektronneutrino und ^{56}Cobalt zu ^{56}Eisen, einem Proton und 
    einem Elektronneutrino.

    \subsection{Akkretierender weißer Zwerg -> weniger Neutrinos?}
