...
\end{align}
$\lambda$ ist hierbei die Wellenlänge des einfallenden Lichts und $A_0$. % A_0 erklären
...
\begin{figure}[H]
    ...
    \label{fig:3}
\end{figure}
\flushleft{Zuerst\,}\justifying wird der Laser in Richtung der Blende ausgerichtet und parallel zur Messschiene
...
\begin{align}
    ...
    b_{\text{relerr}} &= \text{\input{relerr_b.tex}}.
\end{align}
...
gemessen worden ist. Zudem könnte der Laser nicht erfekt auf den Spalt ausgerichtet worden
