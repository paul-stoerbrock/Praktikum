...
\center{\Large Versuchsgruppe: \textbf{42}}
    ...
    \begin{abstract}
        Ziel: Bestimmung der Federkonstante mithilfe des hookschen Gesetzes. 
    \end{abstract}
...
\section{Versuchsaufbau:}
    ...
    anzeigen, welches zwischen den beiden Stative befestigt wird. Das Newton Meter wird an einen Laptop angeschlossen um die entsprechende
...
\section{Versuchsdurchführung:}
    ...
    Anschlie\ss end wird mit Hilfe der Formel \eqref{eq.mean} der Mittelwert von der Federkonstante $D$ berechnet.
    \begin{align*}
...
\newpage
    ...
    \end{equation}
    Mittelwert von D: $\overline{D}$\:=\:\input{meanD.tex}
    ...
    Daraus folgt die Federkonstante\:D\:=\:\input{linregD.tex}
