...
<<<<<<< HEAD
    \sigma _f &= \sqrt{\sum_{i=1}^{N} \left( \frac{\partial f}{\partial x_i} \right)^2 \cdot (\sigma x_i)^2} \label{eq:10c}
||||||| merged common ancestors
    \sigma f &= \sqrt{\sum_{i=1}^{N} \left( \frac{\partial f}{\partial x_i} \right)^2 \cdot (\sigma x_i)^2} \label{eq:10c}
=======
    \sigma_f &= \sqrt{\sum_{i=1}^{N} \left( \frac{\partial f}{\partial x_i} \right)^2 \cdot (\sigma x_i)^2} \label{eq:10c}
>>>>>>> 637a0ec6d0dc93734b61c85c10d43268b7aa7314
...
\flushleft{Um\;}\justifying die zwei Differentialquotienten $\sfrac{d_{T1}}{dt}$ und $\sfrac{d_{T2}}{dt}$ zu berechnen, wird die Formel
\begin{align}
    \frac{dT(t)}{dt} = 2At + B \label{eq:12}
\end{align}
benötigt. Mit der gaußschen Fehlerfortpflanzung \eqref{eq:10c} folgt:
\begin{align}
    \sigma_T = \sqrt{4t^2 \cdot \sigma A^2 + t^2 \cdot \sigma B^2} \label{eq:13}
\end{align}
