...
\begin{align}
    \sigma_T = \sqrt{4t^2 \cdot \sigma_{A}^2 + t^2 \cdot \sigma_{B}^2} \label{eq:13}
\end{align}
...
\begin{align}
    \sigma_{\nu_{real}} = \sqrt{\frac{1}{N^2} \cdot \sigma_{\frac{\delta Q_i}{\delta t}}^2 + \left( \frac{-\delta Q_i}{\delta t N^2} \right)^2 \cdot \sigma_{\frac{1}{N}}^2} \label{eq:15}
\end{align}
