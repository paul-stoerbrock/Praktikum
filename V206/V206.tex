...
\begin{subequations}
\begin{align}
    m_{T1} &= \text{\input{parT1_a.tex}} \qquad \text{und} \qquad &b_{T1} = \text{\input{parT1_b.tex}} \label{eq:11a}\\
    m_{T2} &= \text{\input{parT2_a.tex}} \qquad \text{und} \qquad &b_{T2} = \text{\input{parT2_b.tex}} \label{eq:11b}
\end{align}
\end{subequations}
