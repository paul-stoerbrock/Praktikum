...
\flushleft{Die\;}\justifying Temperatur der einzelnen Reservoire werden mithilfe der Messwerte in Tabelle \ref{tab:1} erstellt. Die für
...
%\begin{subequations}
%\begin{align}
%    a_{T1} &= \text{\input{parT1_a.tex}} \qquad \text{und} \qquad &a_{T2} = \text{\input{parT2_a.tex}} \label{eq:11a}\\
%    b_{T1} &= \text{\input{parT1_b.tex}} \qquad \text{und} \qquad &b_{T2} = \text{\input{parT2_b.tex}} \label{eq:11b}\\
%    c_{T1} &= \text{\input{parT1_c.tex}} \qquad \text{und} \qquad &c_{T2} = \text{\input{parT2_c.tex}} \label{eq:11c}\\
%    d_{T1} &= \text{\input{parT1_d.tex}} \qquad \text{und} \qquad &d_{T2} = \text{\input{parT2_d.tex}} \label{eq:11d}
%\end{align}
%\end{subequations}
\newpage
