...
\flushleft{Für\;}\justifying den Bereich kleiner als ein Bar wurden Messwerte aufgenommen und in der folgenden Tabelle \ref{tab:1} aufgetragen:
...
\flushleft{Die\;}\justifying Steigung der Ausgleichsgeraden wird dabei mit Formel \eqref{eq:6e} und die Verdampfungswärme mit Formel \eqref{eq:}
bestimmt. 
