...
\flushleft{Die\;}\justifying Parameter $m$ und $b$ werden mit dem Python Befehl polyfit bestimmt. Die Verdampfungswärme $L$ lässt sich mit dem 
negativen Parameter $m$ und der Gaskonstante $R$ berechnen. Demnach ergibt sich $L = -m \cdot R$.
...
\begin{align}
    a &= \text{\input{parg1b_a.tex}},\\
    b &= \text{\input{parg1b_b.tex}},\\
    c &= \text{\input{parg1b_c.tex}} \quad \text{und}\\
    d &= \text{\input{parg1b_d.tex}} .
\end{align}
...
\begin{align} 
    ...
    \overline{\frac{dp}{dT}}&= \text{\input{dpdT.tex}}
\end{align}
