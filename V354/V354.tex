...
\end{align}
zeigt, dass sich bei der Wert $\sfrac{\pi}{2}$ bei \cite{V354}
\begin{align}
    \omega _0^2 = \frac{1}{LC} \label{eq:omega0}
\end{align}
ergibt.
Wird $\omega _0 $ um $\pm\sfrac{\pi}{4}$ verschoben, so ergeben sich die Werte \cite{V354}
\begin{align}
    \omega_{1,2} = \pm \frac{R}{2L} + \sqrt{\frac{R^2}{4L^2} + \frac{1}{LC} } \label{eq:om12}
\end{align}
für $\omega _1$ und $\omega _2$.
Daraus lässt sich die Beziehung \cite{V354}
\begin{align}
