...
%Auswertung 5b ----------------------------------------------------------------------------------------------------------------------------------------
  ...
  \flushleft{Der }\justifying aus dem Experiment bestimmte Widerstand beim aperiodischen Grenzfalls lautet:
  \begin{equation}
...
\flushleft{Der }\justifying Kurve der gemessen Werte für a) liegt nahe der erwarteten Kurve aus der Theorie. Bei einer angelegten 
...
\flushleft{Die} im Graphen \ref{fig:4dln} gefittete Kurve entspricht den Messwerten nichtmal im Ansatz.
...
\flushleft{Mit }\justifying den Erkenntnissen aus Aufgaben c) und d) lässt sich folgern, dass das vorliegende System nach Formel 
