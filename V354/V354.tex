...
%Auswertung 5c ----------------------------------------------------------------------------------------------------------------------------------------
  ...
  \flushleft{Die }\justifying Ausgleichskurve wurde dabei mit der Formel \eqref{eq:9} erstellt,
...
%Auswertung 5d ----------------------------------------------------------------------------------------------------------------------------------------
  ...
  \flushleft{Die\;} gefittete Kurve wurde hier mit der Formel \eqref{eq:phi} erstellt. Die Fitparameter
...
\flushleft{Der }\justifying für b) berechnete Widerstand \eqref{eq:Rap} zeigt einen hohen relativen Fehler von $73.48\%$. 
