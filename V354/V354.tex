...
\center{\Large Versuchsgruppe: \textbf{42}}
    ...
    \begin{abstract}
    \centering
        \textbf{Ziel:} Bestimmung des Dämpfungswiderstands eines LRC-Kreises. 
    \end{abstract}
...
\flushleft{Daraus }\justifying folgt ein relativer Fehler von
...
%Auswertung 5b ----------------------------------------------------------------------------------------------------------------------------------------
  ...
  \begin{equation}
  \frac{R_{\text{ap}} - R_{\text{ap,Lit.}}}{R_{\text{ap,Lit.}}} = \text{\input{RF_R.tex}} \label{eq:RapAbw}
  \end{equation}
  an.
...
%Auswertung 5c ----------------------------------------------------------------------------------------------------------------------------------------
  ...
  \flushleft{Die }\justifying Ausgleichskurve wurde dabei mit $\sfrac{U_C}{U_0}$ bestimmt.
  ...
  q_{\text{Lit.}} &= \text{\input{q_lit.tex}}.
...
%Auswertung 5d ----------------------------------------------------------------------------------------------------------------------------------------
  ...
  \begin{align}
    ...
    \frac{\nu_2 - \nu_{2,\text{Lit.}}}{\nu_{2,\text{Lit.}}} &= \text{\input{RF_nu2.tex}} \\
...
\flushleft{Der }\justifying für b) berechnete Widerstand \eqref{eq:Rap} zeigt einen hohen relativen Fehler \eqref{eq:RapLit}. 
...
Dabei entspricht die gefittete Kurve in keinester Weise den Messwerten. Auch der theoretisch erwarteten Kurve2*np.pi* entspricht sie nicht, da die Breite der Resonanzkurve zu
...
\flushleft{Die} im Graphen \ref{fig:4dln} gefittete Kurve entspricht nicht den Messwerten.
...
\flushleft{Aus }\justifying den für d) berechneten Werten für $\nu_{1,2,\text{res.}}$ \eqref{eq:36} und deren relativen Fehlern \eqref{eq:37}
