...
\flushleft{Dieser\;} könnte durch die fehlerhafte Interpretation der Skalierung des variablen Widerstandes erklärt werden. Denn die Skalaierung 
...
Fehler von der Resonanzüberhöhung $q$ \eqref{eq:} 
\begin{align}
\frac{q - q_{\text{lit}}}{q_{\text{lit}}}&= \text{\input{RF_q.tex}}
\intertext{und $\omega _+ - \omega_-$ \eqref{eq:}}
