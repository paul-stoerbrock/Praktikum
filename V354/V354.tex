...
%Auswertung 5a ----------------------------------------------------------------------------------------------------------------------------------------
  ...
  $R_{eff} =$
Der Wert für die Abklingdauer nach Formel \eqref{eq:T_ex} ergibt dabei:
...
%Auswertung 5c ----------------------------------------------------------------------------------------------------------------------------------------
  ...
  und der Formel \eqref{eq:om+-}. Der errechnete Wert für $\omega_+ - \omega_-$ sieht aus wie folgt:
  ...
  q = \text{\input{q.tex}}
  \end{equation}
  Der relative Fehler der Güte des Schwingkreises ergibt:
  \begin{equation}
