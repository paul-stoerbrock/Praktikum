...
%Auswertung 5d ----------------------------------------------------------------------------------------------------------------------------------------
  ...
  \flushleft{Mit }\justifying den Messwertpaaren $(\nu, t)$ aus Tabelle \ref{tab:data_c} lassen sich die folgenden zwei Graphen erstellen:
  ...
  \flushleft{Anhand }\justifying des ersten Graphen können die Werte für $\nu_1 \; \text{bei} \; \sfrac{\pi}{4}$, $\nu_2 \; \text{bei} \; \sfrac{\pi}{2}$ und 
  $\nu_3 \; \text{bei} \; \sfrac{3\pi}{4}$ abgelesen werden. Daraus folgen die Werte $\nu_{1,2,res.}$:
  \begin{subequations}
  \begin{align}
    &\nu_1 = \text{\input{nu1.tex}}\\
    &\nu_2 = \text{\input{nu2.tex}}
