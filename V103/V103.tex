...
\begin{align}
    &\text{Länge des Kupferstabs L:} \qquad &\text{\input{l_Cu.tex}} \label{eq:8a}\\
    &\text{Mittelwert der Breite des Kupferstabs b:} \qquad &\text{\input{d_Cu.tex}} \label{eq:8b}\\
    &\text{Mittelwert der Dicke des Kupferstabs d:} \qquad &\text{\input{b_Cu.tex}} \label{eq:8c}\\
...
\end{align}
\end{subequations}
Die Mittelwerte für die Dicke d und die Breite b wurden dabei mit Tabelle berechnet.
\flushleft{Um\;}\justifying das Flächenträgheitsmoment eines rechteckigen Stabes mit der Breite b und der
...
\flushleft{Die\;}\justifying folgende Tabelle \ref{tab:1} gibt die Biegung des Kupferstabs mit und ohne Gewicht wieder. $x$ beschreibt den Abstand zum Fixpunkt, $D_0$
...
\flushleft{Für\;}\justifying das Flächenträgheitsmoment eines runden Stabes mit dem Durchmessers d, wird die Formel \eqref{eq:3} 
