...
Die Maße des Kupferstabes sowie die Massen der Aufhängvorrichtung lauten:
...
$E_{Al(links)}$ = \input{E_Aldopl.tex}

$E_{Al(rechts)}$ = \input{E_Aldopr.tex}
