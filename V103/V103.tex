...
für gegebene Probleme die optimalen Materialien zu finden. Eine Eigenschaft die vorallem im Bau von zum Beispiel
Kränen oder Windkraftwerken relevant sein dürfte,
bildet der Elastizitätsmodul. Daher sich im folgenden der  Elastizitätsmodul von zwei metallischen
Stäben anhand einer einseitig und doppeltseitig fixierten Biegung bestimmt werden.
...
\centering
    ...
    \toprule
        ...
        $E_{Cu}$            & \text{\input{E_Cuein.tex}}    & 124   & \text{\input{E_Cueinerr.tex}}\\
        $E_{Cu(links)}$     & \text{\input{E_Cudopl.tex}}   & 124   & \text{\input{E_Cudoplerr.tex}}\\
        $E_{Cu(rechts)}$    & \text{\input{E_Cudopr.tex}}   & 124   & \text{\input{E_Cudoprerr.tex}}\\
