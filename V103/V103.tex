...
\begin{align}
    ...
    &E_{Al(rechts)} = \text{\input{E_Aldopr.tex}} \label{eq:28}
\end{align}

% Diskussion %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\section{Diskussion}\justifying
Die Tabelle \ref{tab:1} gibt mehere Messwerte der Breite und Dicke des Kupferstabes wieder. Die Messwerte dienen der Veranschaulichug, dass es sich
...
welches auch im Graphen \ref{fig:1} deutlich wird. Dies könnte einerseits auf die Beschaffenheiten der Messuhr und der Aperatur zurückzuführen 
...
Graphen \ref{frig:1} und die dazugehörige lineare Regression benötigt wurde, wurde gewählt gemäß des in \ref{sec:1} beschriebenen Umstands des 
...
Die Messwerte der Doppelbiegung aus Tabelle \ref{tab:3} weisen für beide Seiten in der Differenzspalte eine große Ähnlichkeit auf. Die Graphen
\ref{fig:2a} und \ref{fig:2b} verdeutlichen diese Ähnlichkeit, da die Steigungen der beiden Geraden \eqref{eq:16a} und \eqref{eq:16b} nahezu
identisch sind. 

Werden nun der Wert des Elastizitätmoduls der Einzelbiegung \eqref{eq:14} mit den Werten der Elastizitätmodule der Doppelbiegung \eqref{eq:17}
...
sich hierbei wahrscheinlich um Kupfer handelt.
