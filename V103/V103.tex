...
\begin{align}
    &\text{Länge des Kupfterstabs:} \qquad &\text{\input{l_Cu.tex}} \label{eq:8a}\\
    &\text{Mittelwert der Breite des Kupfterstabs ($\overline{b}$):} \qquad &\text{\input{d_Cu.tex}} \label{eq:8b}\\
    &\text{Dicke des Kupfterstabs:} \qquad &\text{\input{b_Cu.tex}} \label{eq:8c}\\
...
\flushleft{Um\;}\justifying das Flächenträgheitsmoment eines rechteckigen Stabes mit der Breite d und der
