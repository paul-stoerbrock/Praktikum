...
\begin{subequations}\label{eq:}
\begin{align}
    m &= \text{\input{m_PlotCudopl.tex}} \qquad
    b = \text{\input{b_PlotCudopl.tex}}\label{eq:a} \text{für 3a}\\
    m &= \text{\input{m_PlotCudopr.tex}} \qquad
    b = \text{\input{b_PlotCudopr.tex}}\label{eq:b} \text{für 3b}
\end{align}
\end{subequations}
