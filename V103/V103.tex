...
werden die Gewichte abgenommen und die Kupferstange an beiden Enden fixiert. Dabei ist zu beachten, dass keines der beiden Enden fest eingespannt wird. 
Nun wird die Durchbiegung an 14 Stellen mit einem Abstand von $\SI{3}{\centi\meter}$ gemessen. Danach werden vier $\SI{1160}{\gram}$ Gewichte mittig an 
die Stange gehangen und die Messungen wiederholt. Anschließend werden die Länge und Breite des Stabs an zehn verschiedenen Stellen gemessen.
...
Gewicht durchgeführt. Wie beim Kupferstab wird hier der Durchmesser an zehn verschiedenen Stellen des Stabs abgenommen.
...
\flushleft{Die\;}\justifying Tabelle \ref{tab:1} gibt mehere Messwerte der Breite und Dicke des Kupferstabes wieder. Die Messwerte dienen der Veranschaulichug, dass es sich
...
\flushleft{Werden\;}\justifying nun der Wert des Elastizitätmoduls der Einzelbiegung \eqref{eq:14} mit den Werten der Elastizitätmodule der Doppelbiegung \eqref{eq:17}
...
\flushleft{Wie\;}\justifying beim Kupferstab wird der Durchmesser des Aluminiumstabes an zehn verschiedenen Stellen gemessen, die in Tabelle \ref{tab:4}
...
\flushleft{Werden\;}\justifying nun der Elastizitätmodul \eqref{eq:25} der Einzelbiegung mit den Elastizitätmodulen der Doppelbiegung \eqref{eq:28}
