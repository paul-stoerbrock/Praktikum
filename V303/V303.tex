...
\end{align}
bestimmen. Wird diese Spannung mit der Amplitude $U = \SI{6.57}{\volt}$ aus Abbildung \ref{fig:7b} verglichen, lässt sich ein Verstärkungsfakor
...
\end{align}
bestimmen. Um den Verstärkungsfakor zu berechnen, wird hier ebenfalls die Amplitude $U = \SI{6.57}{\volt}$ aus Abbildung \ref{fig:7b} verwendet.
