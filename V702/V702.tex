...
\begin{figure}[H]
    ...
    \label{fig:5} 
\end{figure}
\flushleft{Die\,}\justifying lilane Fitkurve ist mit der Funktion curvefit aus Scipy \cite{scipy} erstellt
...
\begin{align}
    ...
    A &= \text{\input{A_Rh.tex}} \label{eq:18b}\\
    B &= \text{\input{B_Rh.tex}} \label{eq:18c}\\
    C &= \text{\input{C_Rh.tex}} \label{eq:18d}\\
    D &= \text{\input{D_Rh.tex}} \label{eq:18e}\\
    E &= \text{\input{E_Rh.tex}} \label{eq:18f}.
\end{align}
\end{subequations}
