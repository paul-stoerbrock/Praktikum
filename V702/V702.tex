...
\section{Versuchsaufbau und Versuchsdurchführung}\justifying
    ...
    \flushleft{Um\:}\justifying die Halbwertszeit der Materialien Vanadium und Rhodium bestimmen zu können, wird der folgende Aufbau verwendet.
    \begin{figure}
        \centering
    ...
    \flushleft{Für\:}\justifying die Messung der Vanadiumprobe wird diese auf das Geiger-Müller-Zählrohr gesteckt. Es werden 44 Messwerte für die
    Impulsrate aufgenommen, mit einem Messintervall von \SI{30}{\second}. 

    \flushleft{Mit\:}\justifying Rhodium wird analog zu Vanadium verfahren. Die Vanadiumprobe wird abgenommen und mit der Rhodiumprobe ersetzt.
