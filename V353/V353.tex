...
%Auswertung 4a %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  Aus diesen Messwerten wurde dann mithilfe des Programms Scipy \cite{scipy} eine
  Ausgleichsgerade berechnet mit den Parametern

  \begin{align}
    m &= \text{\input{slope.tex}} \label{eq:slope} \\
    b &= \text{\input{intercept.tex}} \label{eq:inter}
  \end{align}
