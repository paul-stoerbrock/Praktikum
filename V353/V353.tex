...
\section{Theorie}\justifying
  ...
  Aus Gl. \eqref{eq:A} ergibt sich eine weitere Eigenschaft des RC-Glieds. Bei niedrigen 
...
% Auswertung 4b %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  Der Tabelle \ref{tab:data} werden die Frequenz $\nu$ und die Zeit $\Delta T$ entnommen um mit der Formel \eqref{eq:nu2} das 
  ...
  \begin{figure}[H]
  \centering
  \caption{Ausgegebene Schwingungen}
...
Für die Erstellung der Ausgleichskurve des Polarplots wurde die Formel \eqref{eq:nu}
...
zeigen. Zum Beispiel stellt die Rechteckschwingung in Bild \subref{fig:rechteck} 
