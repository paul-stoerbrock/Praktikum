...
nach Formel \eqref{eq:A}. Die Messwerte aus Tabelle \ref{tab:table_4b} stellen allerdings die eigentliche Kurve
dar. Der Grund dafür ist, dass beim Aufschreiben der Messwerte nicht beachte wurde,
