...
with open ('build/I_D.tex', 'w') as f:
  f.write(make_SI(I_D, r'\kilo\gram\square\meter', figures=2))
...
with open ('build/I_Puppe_an_theo.tex', 'w') as f:
  f.write(make_SI(I_Puppe_an_theo, r'\kilo\gram\square\meter', figures=1))

# tex file of I_Puppe_an_exp_mean

with open ('build/I_Puppe_an_exp_mean.tex', 'w') as f:
  f.write(make_SI(I_Puppe_an_exp_mean, r'\kilo\gram\square\meter',figures=1))

# tex file of I_Puppe_aus_theo

with open ('build/I_Puppe_aus_theo.tex', 'w') as f:
  f.write(make_SI(I_Puppe_aus_theo, r'\kilo\gram\square\meter',figures=1))

# tex file of I_Puppe_aus_exp_mean

with open ('build/I_Puppe_aus_exp_mean.tex', 'w') as f:
  f.write(make_SI(I_Puppe_aus_exp_mean, r'\kilo\gram\square\meter',figures=1))
