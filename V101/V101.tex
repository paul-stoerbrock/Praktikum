...
\flushleft{Für} die Berechnung wurde die Periodendauer gemittelt und auf eine Periode normiert.
...
\flushleft{Das\;}\justifying Trägheitsmoment der Drehachse ist nach Formel \eqref{eq:13}:
\input{I_D.tex} % Trägheitsmoment Drehachse

\begin{table}[H] % Federkonstante ---------------------------------------------------------------------------------------------------------
    \centering
    \input{table_D.tex}
...
\begin{equation}
\overline{D} = \text{\input{D_mean.tex}} \label{eq:16} % Federkonstante der Spiralfeder
\end{equation}
...
\flushleft{Das\;}\justifying experimentelle Trägheitsmoment des Zylinders ist:
