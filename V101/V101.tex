...
\flushleft{Werden\;}\justifying die Werte aus \ref{tab:1} in die Formel \eqref{eq:11} eingesetzt, 
...
\begin{subequations}
\begin{align}
\intertext{\flushleft{Für\;}\justifying den experimentellen Wert des Trägheitsmoments des Zylinders wurde die Formel \eqref{eq:14} nach $I_S$ umgestellt.
