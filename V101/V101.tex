...
\subsubsection{Puppe Position 1}\label{sec:Puppe1} % Puppe 1 ---------------------------------------------------------------------------------------------------------
...
\subsubsection{Puppe Position 2}\justifying \label{sec:Puppe2} % Puppe 2 ---------------------------------------------------------------------------------------------------------
...
Newtonmeter an die ausgelenkte Stange gehalten, welche danach losgelassen wurde und die Kraft
...
\flushleft{Für\;} den Zylinder ergibt sich ein relaiver Fehler von $37\%$, welcher  sich
